...
<footer class="pt-6">
	<div class="container position-relative mt-sm-5">
		...
		<div class="row g-3 g-md-4 align-items-center">
			<div class="col-md-6">
				<h2 class="mb-0 lh-base">We
					<span class="position-relative z-index-1">can't wait
						<!-- SVG START -->
						<span
							class="position-absolute top-50 start-50 translate-middle z-index-n1 ms-n2 d-none d-lg-block">
							<svg width="210" height="64" viewBox="0 0 188 53" fill="none"
			...
			<div class="col-md-5 text-md-end ms-auto">
				<a class="btn btn-lg btn-primary-soft icon-link icon-link-hover mb-0" href="#custom">Personalise my number<i
		...
		<div class="row g-4 justify-content-between">
				...
				<div class="row g-4">
					...
					<div class="col-6 col-md-3">
						...
						<ul class="nav flex-column">
							<li class="nav-item"><a class="nav-link pt-0" href="#process">How it works</a></li>
					...
					<!-- Link block -->
					<div class="col-6 col-md-3">
						<h6 class="mb-2 mb-md-4">Legal bits</h6>
						<ul class="nav flex-column">
					...
					<div class="col-md-6">
						...
						<ul class="list-group list-group-borderless">
							<li class="d-flex mb-3"><i class="me-2 text-primary bi bi-headset"></i> +447999 999 553 </li>
							<li class="d-flex mb-3"><i class="me-2 text-primary bi bi-envelope"></i> info@createnumbers.com
							</li>
							<li class="d-flex mb-3"><i class="me-2 text-primary bi bi-clock"></i>
								<p class="mb-0">Mon - Fri: <strong>09:00 - 18:00</strong> <br>Sat - Sun:
			...
			<div class="col-lg-3">
				...
				<ul class="list-inline mb-0 mt-3">
					<li class="list-inline-item"> <a class="btn btn-xs btn-icon bg-facebook" href="https://www.facebook.com/people/Create-Numbers/100067590341398/" rel="noopener noreferrer nofollow" target="_blank"><i
								class="fab fa-fw fa-facebook-f lh-base"></i></a> </li>
					<li class="list-inline-item"> <a class="btn btn-xs btn-icon bg-instagram" href="https://www.instagram.com/createnumbers/" rel="noopener noreferrer nofollow" target="_blank"><i
		...
		<div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-3">
			...
			<div class="text-body mt-3 mt-md-0">
				Copyrights ©2024 Create Numbers Ltd. Registered in England & Wales company number
				<a href="https://find-and-update.company-information.service.gov.uk/company/14217243"
					class="text-body text-primary-hover" rel="noopener noreferrer nofollow" target="_blank">14217243</a>
			</div>
			<!-- Copyright link-->
		</div>
	</div>
